...
| Variable                  | Description                                                                                                                                                         | Example / Default |
| :------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---------------- |
| `STORAGE_CATALOG_ENABLED` | Keep a small JSON record of every project, folder, file, metadata field and metadata value in storage under `catalog/`, updated within a few seconds of any change. | `false` (default) |
